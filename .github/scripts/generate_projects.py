...
THEMES = {
    "dark": {
        ...
        "CYAN": "#38BDF8", "VIOLET": "#A78BFA", "VIOLET2": "#7C3AED",
        "EMERALD": "#10B981", "TEXT": "#F8FAFC", "MUTED": "#94A3B8",
        "DIM": "#475569",
        "STROKE": "rgba(56,189,248,0.28)", "STROKE_HI": "rgba(56,189,248,0.5)",
        "STROKE_LO": "rgba(56,189,248,0.22)", "BARLINE": "rgba(255,255,255,0.08)",
    ...
    "light": {
        ...
        "CYAN": "#0284C7", "VIOLET": "#7C3AED", "VIOLET2": "#7C3AED",
        "EMERALD": "#059669", "TEXT": "#0F172A", "MUTED": "#475569",
        "DIM": "#94A3B8",
        "STROKE": "rgba(2,132,199,0.30)", "STROKE_HI": "rgba(2,132,199,0.55)",
        "STROKE_LO": "rgba(2,132,199,0.20)", "BARLINE": "rgba(0,0,0,0.08)",
